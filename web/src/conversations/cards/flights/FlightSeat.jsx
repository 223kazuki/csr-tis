    ...
    try {
      ...
      return (
        <div className='flightSeats'>
          <div className='selectedSeat'></div>
          <div className='selectSeatLabel'>
            <span onClick={this.showExpanded.bind(this)}>座席を選択する</span>
          </div>
        </div>
      )
    } catch (e) {
...
const messagePartsForFlightSeat = (data, params={}) => {
  const body = {
    title: params.title || '',
